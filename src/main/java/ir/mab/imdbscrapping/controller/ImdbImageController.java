...
public class ImdbImageController {
    ...
    @GetMapping("/gallery/{galleryId}/slider")
    @ApiOperation("Images of a gallery as slider with details")
    ApiResponse<ImageGallery> fetchImagesOfGalleryAsSliderWithDetails(
            @ApiParam("Ex. rg1858378496")
            @PathVariable("galleryId") String galleryId,
            @ApiParam("Ex. rm4288413441")
            @RequestParam(value = "imageId", required = false) String imageId,
        ...
        try {
            JSONObject reqObject = new JSONObject();
            reqObject.put("query", "query GalleryImages($id: ID!, $before: ID, $after: ID, $jumpTo: ID, $first: Int, $last: Int, $lastYes: Boolean!, $firstYes: Boolean!) {\n  imageGallery(id: $id) {\n    galleryText\n    images(first: $first, after: $after, jumpTo: $jumpTo) @include(if: $firstYes) {\n      total\n      ...MediaViewerMeta\n      __typename\n    }\n    wrapFront: images(last: $last, before: $before) @include(if: $lastYes) {\n      total\n      ...MediaViewerMeta\n      __typename\n    }\n    wrapBack: images(first: $first) @include(if: $firstYes) {\n      total\n      ...MediaViewerMeta\n      __typename\n    }\n    __typename\n  }\n}\n\nfragment MediaViewerMeta on ImageConnection {\n  pageInfo {\n    endCursor\n    hasNextPage\n    hasPreviousPage\n    startCursor\n    __typename\n  }\n  edges {\n    position\n    cursor\n    node {\n      ...MediaViewerImageMeta\n      ...MediaSheetImageMeta\n      __typename\n    }\n    __typename\n  }\n}\n\nfragment MediaViewerImageMeta on Image {\n  id\n  url\n  height\n  width\n  caption {\n    plainText\n    __typename\n  }\n}\n\nfragment MediaSheetImageMeta on Image {\n  copyright\n  createdBy\n  caption {\n    plaidHtml\n    __typename\n  }\n  titles {\n    id\n    titleText {\n      text\n      __typename\n    }\n    __typename\n  }\n  source {\n    attributionUrl\n    text\n    banner {\n      url\n      attributionUrl\n      __typename\n    }\n    __typename\n  }\n  names {\n    id\n    nameText {\n      text\n      __typename\n    }\n    __typename\n  }\n  countries {\n    text\n    __typename\n  }\n  languages {\n    text\n    __typename\n  }\n  correctionLink(relatedId: $id, contributionContext: {isInIframe: true, returnUrl: \"https://www.imdb.com/close_me\", business: \"consumer\"}) {\n    url\n    __typename\n  }\n  reportingLink(relatedId: $id, contributionContext: {isInIframe: true, returnUrl: \"https://www.imdb.com/close_me\", business: \"consumer\"}) {\n    url\n    __typename\n  }\n}\n");
            reqObject.put("variables", initVariableObject(galleryId, imageId, beforeId, afterId, first, last));
            params = new StringEntity(reqObject.toString());
            httppost.addHeader("content-type", "application/json");
            httppost.setEntity(params);
            HttpResponse response = httpClient.execute(httppost);
            JSONObject responseJson = new JSONObject(EntityUtils.toString(response.getEntity(), "UTF-8"));
            System.out.println("aminnasd " + responseJson);

            try {
                imageGallery.setTitle(responseJson.getJSONObject("data").getJSONObject("imageGallery").getString("galleryText"));
            } catch (Exception e) {
                e.printStackTrace();
            }

            try {
                imageGallery.setEndCursor(responseJson.getJSONObject("data").getJSONObject("imageGallery").getJSONObject("images").getJSONObject("pageInfo").getString("endCursor"));
            } catch (Exception e) {
                e.printStackTrace();
            }
            try {
                imageGallery.setStartCursor(responseJson.getJSONObject("data").getJSONObject("imageGallery").getJSONObject("images").getJSONObject("pageInfo").getString("startCursor"));
            } catch (Exception e) {
                e.printStackTrace();
            }
            try {
                imageGallery.setHasNextPage(responseJson.getJSONObject("data").getJSONObject("imageGallery").getJSONObject("images").getJSONObject("pageInfo").getBoolean("hasNextPage"));
            } catch (Exception e) {
                e.printStackTrace();
            }
            try {
                imageGallery.setHasPreviousPage(responseJson.getJSONObject("data").getJSONObject("imageGallery").getJSONObject("images").getJSONObject("pageInfo").getBoolean("hasPreviousPage"));
            } catch (Exception e) {
                e.printStackTrace();
            }
            ...
            try {
                ...
                for (Object o : responseJson.getJSONObject("data").getJSONObject("imageGallery").getJSONObject("images").getJSONArray("edges")) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            try {
                                setImageFields(image, node);
                            } catch (Exception e) {
                                e.printStackTrace();
                            }

                            try {
                                JSONObject description = node.getJSONObject("caption");
                            ...
                            try {
                                JSONObject description = node.getJSONObject("caption");
                                image.setCaption(description.getString("plainText"));
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                        } catch (Exception e) {
